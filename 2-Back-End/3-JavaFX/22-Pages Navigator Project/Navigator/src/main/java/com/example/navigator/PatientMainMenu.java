...
public class PatientMainMenu
{
    ...
    private Label LBL2 = new Label("Patient Main\n  Menu");
    private Label Message = new Label("");
    private RadioButton RDR1 = new RadioButton("1-Update Personal Info.");
    private RadioButton RDR2 = new RadioButton("2-Show Personal Info.");
    private RadioButton RDR3 = new RadioButton("3-Show All Doctors.");
