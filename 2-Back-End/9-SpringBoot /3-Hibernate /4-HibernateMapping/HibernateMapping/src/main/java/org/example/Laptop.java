...
@Embeddable // Marks this class as embeddable (can be part of another entity's table)
...
public class Laptop
{
    ...
    @ManyToOne // INCORRECT: Defines many-to-one relationship (conflicts with below)
