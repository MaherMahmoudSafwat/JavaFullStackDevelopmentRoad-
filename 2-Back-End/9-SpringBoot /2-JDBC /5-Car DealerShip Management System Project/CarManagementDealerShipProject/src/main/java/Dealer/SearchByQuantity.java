...
public class SearchByQuantity
{
    private static int SearchBy = 0;
    private static void Search()
    {
        CarSettings Car = new CarSettings();
        ArrayList<Car> ListOfCarsSearchedByBrand = Car.SearchByQuantity(SearchBy);
    ...
    {
        System.out.println("\nPlease enter the car quantity you want to search for :- ");
